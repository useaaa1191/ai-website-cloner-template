...
export function HeroSection({
  ...
  return (
    <section className="relative -mb-20 flex h-[calc(100svh-var(--header-h))] min-h-[400px] max-h-[680px] flex-col px-6 pb-6 pt-2 md:px-8">
      {/* Title + input: vertically centered in available space */}
      ...
      {/* Chips: pinned to bottom of hero */}
